...
Figure out robust artifact definitions for every output in this workflow. The YAML names every artifact but specifies no schema. I need explicit contracts before I can write agent prompts.
...
nodes:
  ...
  architect:
    ...
    inputs:
      ...
      repo_architecture: repo:ARCHITECTURE.md
  ...
  test_arch:
    ...
    inputs:
      ...
      repo_test_architecture: repo:docs/sdet/TEST-ARCHITECTURE.md
